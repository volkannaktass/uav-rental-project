...
### To create specific form to use in the template, we have to write some proporties
class RegisterForm(forms.Form):
     ...
     def clean(self):
         ...
         '''
         get data from the templates and control the user
         exists or not, then control the passwords and E-mail
         is valid or not
         '''
